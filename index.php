	...
	<div class="heading">
		...
		<div class="body" >
			...
			<div class="loginPanel">
				<form method="POST" action="res_index.php">
					<input type="email" name="email" placeholder="Email" class="form-control" required>
					<input type="password" name="password" placeholder="Password" class="form-control" required><?php  if($msg!=""){
				...
				<button class="btn btn-primary form-control" style="margin-top:1em" id="forgotpassword">Forgot Password</button>
		</div>
	</div>
